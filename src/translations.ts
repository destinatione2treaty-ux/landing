...
export const translations = {
  es: {
    ...
    hero: {
      ...
      ctaButton: `SÍ, QUIERO ACCESO INMEDIATO A "${product.name.toUpperCase()}" POR ${pricing.currentPrice}`,
  ...
  en: {
    ...
    hero: {
      ...
      ctaButton: `YES, I WANT IMMEDIATE ACCESS TO "${product.name.toUpperCase()}" FOR ${pricing.currentPrice}`,
